...
export async function createSystemContextWithAuth(settings) {
    const authToken = settings.fetchers?.octokit || settings.auth || settings.offline
        ? undefined
...
//# sourceMappingURL=createSystemContextWithAuth.js.map