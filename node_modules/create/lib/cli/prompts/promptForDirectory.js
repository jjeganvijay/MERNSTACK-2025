...
export async function promptForDirectory({ requestedRepository, requestedDirectory = requestedRepository, template, }) {
    ...
    const directory = await prompts.text({
        ...
        message: "What will the directory and name of the repository be? (--directory)",
...
//# sourceMappingURL=promptForDirectory.js.map