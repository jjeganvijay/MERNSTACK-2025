...
describe("logSchemasHelpOptions", () => {
    test("schemas", () => {
        logSchemasHelpOptions("create-my-app", {
            ...
            transformed: z
                ...
                .transform(vi.fn())
                .describe("email address to be listed as the point of contact in docs and packages"),
...
//# sourceMappingURL=logSchemasHelpOptions.test.js.map